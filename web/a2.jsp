...
<table width="100%">
    <tr><td style="width: 35%;text-align: left">
        ...
        <td style="width: 35%;text-align: right;vertical-align: middle;">
            ...
            <img style="vertical-align: middle" src="icons/cart.png" >

            <img style="vertical-align: middle" src="icons/login.png" >
        </td></tr>
</table>

<table height="33%" width="100%">
...
<div style="background-color: #262626;font-size: 17pt;color: white;padding:6% 6% 6% 6%;">
    <div style="width: 60%;float: left;">
        <table style="width: 50%;color: white;float: left;">
            <tr style="font-size: 18pt;font-weight: bold;height: 70px;"><td><%=tit.gettitle0("_main")%></td>
            </tr>
        ...
        <table style="width: 50%;color: white;float: left;">
            <tr style="font-size: 18pt;font-weight: bold;height: 70px;">
                <td><%=tit.gettitle0("_prodakts")%></td></tr>
            <tr style="font-size: 17pt;">
                <td><a href="" style="text-decoration: none;color:white;"><%=tit.gettitle0("_car")%></a></td></tr>
            <tr style="font-size: 17pt;">
                <td><a href="" style="text-decoration: none;color:white;"><%=tit.gettitle0("_liability")%></a></td></tr>
            <tr style="font-size: 17pt;">
    ...
    <table style="width: 40%;color: white;">
        <tr style="font-size: 18pt;font-weight: bold;height: 70px;"><td><%=tit.gettitle0("_download")%></td></tr>
        <tr><td>
        ...
        <tr style="font-size: 18pt;font-weight: bold;height: 50px;"><td><%=tit.gettitle0("_connect")%></td></tr>
        <tr><td>
